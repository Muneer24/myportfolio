<template>
<section class="py-10 sm:py-16 lg:py-24" style="background-image: linear-gradient(to top, #b224ef 0%, #7579ff 100%);">
  <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
          <div class="flex flex-col justify-between lg:py-5">
              <div>
                  <h2 class="text-2xl font-bold leading-tight text-white sm:text-4xl lg:leading-tight lg:text-5xl">It’s time to build something exciting!</h2>
                  <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">Ready to turn your ideas into reality? I’m excited to collaborate with you and bring your vision to life. Let’s connect and start building something extraordinary together!</p>
              ...
              <div class="hidden md:mt-auto md:block">
                  ...
                  <div class="flex items-center mt-8">
                      <img class="flex-shrink-0 object-cover w-10 h-10 rounded-full" src="../assets/linkedin.png" alt="" />
                      <div class="ml-4">
                          <a href="https://www.linkedin.com/in/muneer-doman-1444ab198/" style="color: white; font-family: poppins;">Lets Connect!</a>
        ...
        <div class="p-6 sm:p-10">
          ...
          <div class="md:hidden">
              ...
              <div class="flex items-center mt-8">
                  ...
                  <div class="ml-4">
                      <p class="text-base font-semibold text-white">Muneer Doman</p>
                      <p class="mt-px text-sm text-gray-400">Full-Stack Dev</p>
                  </div>
              </div>
          </div>
      </div>
...
.custom-gradient:hover {
    background: #9e16c3; /* You can keep the hover effect */
}
